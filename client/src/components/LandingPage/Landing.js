...
const Landing = () => {
  ...
  const [faqs, setFaqs] = useState([
    ...
    },
    {
      ...
      content:
        "We are constantly improving Idealist Search to provide top-notch AI features to employees.  In the upcoming updates, we will provide an improved version of smart search which will directly find top candidates according to a specific job posting, we will also provide a candidate tracking feature which will help hiring managers to track each selected candidate and it will also be helpful for us to improve our AI algorithm. ",
      shown: false,
    },
  ]);
    ...
    <>
     ...
     {!showJob ?<div>
      ...
      <footer className="text-lg-start">
        <div className="text-md-start flex justify-center  pb-36"> 
          {/* Grid row */}
          ...
          <div className="pb-3">
            <div className="flex justify-center text-center space-x-6">
              <div className="mt-2 text-xs">
                <span>Alright reserved © 2023 Idealist</span>
              </div>
              <div className="mt-2 text-xs">
